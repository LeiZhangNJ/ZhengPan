---
title: "code for machine learning"
author: "Zheng Pan"
date: "7/5/2021"
output: 
  pdf_document:
...
st1 <- as.data.frame(read.csv(file = '~/Desktop/ZhengPan/workspace/Github/Zhang-NJ-Lab_ZhengPan/ml/www/光电流数据yingwenred.csv'))
paths <- '~/desktop/SVMpredions.csv'
```
...
This is a slide which demonstrates the a workflow using R programming language.
